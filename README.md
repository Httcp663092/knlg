...
- [财务基础通俗入门：从业务、凭证到报表](docs/01_finance/finance-starter-plain-language-guide.md)
...
- [国外财务与国际化核算专题：多币别、多准则、税务和合并](docs/01_finance/international-finance-accounting-guide.md)
- [海外子公司建账与月结实操包](docs/01_finance/overseas-subsidiary-close-implementation-pack.md)
- [集团合并报表、内部交易抵消与内部往来对账专题](docs/01_finance/consolidated-reporting-elimination-guide.md)
- [集团管理分析、事业部利润与内部转移定价专题](docs/01_finance/group-management-profit-transfer-pricing-guide.md)
- [经营分析月报样例：事业部利润、产品毛利、客户贡献与预算执行](docs/01_finance/management-analysis-monthly-report-sample-guide.md)
- [预算执行分析、占用释放与费用报销联动专题](docs/01_finance/budget-execution-control-analysis-guide.md)
- [发票税务申报勾稽、红字和未开票收入专题](docs/01_finance/tax-declaration-invoice-reconciliation-guide.md)
...
- [渠道售后、服务站库存与经销商代修专题](docs/02_supply-chain/channel-after-sales-service-station-guide.md)
...
- [BOS 插件源码级案例：保存校验、操作服务、单据转换与列表过滤](docs/05_development-bos/plugin-code-cases-save-operation-conversion-guide.md)
...
- 以金蝶云·星空的公开产品手册和个人实践笔记为主。
- 对通用财务概念、实施方法和排查方法做结构化沉淀。
- 具体菜单、字段和参数以实际客户环境、产品版本和授权模块为准。
...
docs/
  00_inbox/                    临时收集箱
  01_finance/                  财务知识区
  02_supply-chain/             供应链知识区
  03_manufacturing/            生产制造知识区
  04_implementation/           实施方法与交付
  05_development-bos/          BOS/插件/二开
  06_data-model-sql/           数据模型与 SQL
