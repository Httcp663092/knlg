...
- 财务：会计循环、科目维度、总账、应收、应收账龄催收、坏账准备、应付、出纳、固定资产、预算、费用报销、月结、业务单据到凭证、现金流、报表分析、税务发票、电子档案、案例和常见问题。
- 供应链：采购、销售、销售退货红冲退款、库存、存货核算、单据流学习、价格信用、批号盘点、暂估、组织间结算、条码仓库、供应商协同、业务到财务衔接。
